namespace Minerals.AutoInterfaces
{
    ...
    public class GenerateInterfaceGenerator : IIncrementalGenerator
    {
        ...
        public static SourceText GenerateInterface(GeneratorAttributeSyntaxContext context)
        {
            ...
            GenerateInterfaceHeader(builder, context.TargetNode);
        ...
        public static void GenerateInterfaceHeader(CodeBuilder builder, SyntaxNode node)
        {
            builder.WriteLine(node.GetAccessModifier().ToString())
                .Write(" interface I")
                .Write(((TypeDeclarationSyntax)node).Identifier.ValueText)
                .OpenBlock();
        }
        ...
        public static void GenerateAllPublicMembers(CodeBuilder builder, SyntaxNode node)
        {
            ...
            var members = type.Members.Where(x => x.HasModifier(SyntaxKind.PublicKeyword));

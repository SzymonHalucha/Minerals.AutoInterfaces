namespace Minerals.AutoInterfaces
{
    ...
    public class InterfaceGenerator : IIncrementalGenerator
    {
        ...
        public static SourceText BuildInterfaceForTargetNode(GeneratorAttributeSyntaxContext context)
        {
            ...
            builder.AddAllUsings(context.TargetNode, out bool hasUsings);
            if (hasUsings)
            {
                builder.WriteLine("");
            }
            builder.AddNamespace(context.TargetNode, out bool hasNamespace);

            builder.AddAutoGeneratedAttributes<InterfaceDeclarationSyntax>();
        ...
        {
            builder.Write(node.GetAccessModifier().ToString())
                .Write(" interface I")
                .WriteLine(((BaseTypeDeclarationSyntax)node).Identifier.ValueText)
                .OpenBlock();
        }
        ...
        {
            builder.Write(method.ReturnType.ToString())
                .Write(" ")
                .Write(method.Identifier.ValueText);

            if (method.TypeParameterList != null)
            {
                builder.WriteLine(method.TypeParameterList!.ToString());
            }
        ...
        {
            builder.Write(property.Type.ToString())
                .Write(" ")

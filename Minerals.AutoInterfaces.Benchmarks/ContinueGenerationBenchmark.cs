...
{
    public class ContinueGenerationBenchmark
    {
        ...
        public void Initialize()
        {
            ...
            Baseline.RunAndUpdateGeneration();
            ...
            WithGenerate.RunAndUpdateGeneration();
        }

        [Benchmark(Baseline = true)]
        public void ContinueGeneration_Baseline()
        {
            Baseline!.RunGeneration();
        }

        [Benchmark]
        public void ContinueGeneration_Interface()
        {
